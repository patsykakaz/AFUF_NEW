...
class EventDocumentation(models.Model):
    ...
    file =  models.FileField(verbose_name='Doc évènement',upload_to='uploads/events/', blank=False, help_text='Documentation disponible au téléchargement pour les utilisateurs loggés')
