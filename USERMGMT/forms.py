...
class NewUserForm(ModelForm):
    ...
    def clean(self):
        ...
        text_content = u"Merci de vous être inscrit sur notre site www.afuf.fr \nVoici vos identifiants de connexion. \nVotre login : "+to+" \nVotre mot de passe : "+password
        html_content = u"<p><b>Merci de vous être inscrit sur notre site www.afuf.fr</b> <br/>Voici vos identifiants de connexion. <br />Votre login : "+to+" <br />Votre mot de passe : "+password+"</p>"
